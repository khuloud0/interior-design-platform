...
def create_design_plan(request_id, data):
    ...
    return {
        "message": "Design plan saved successfully",
        "plan": plan.to_dict()
    }, 201
...
def create_contractor_offer(request_id, data):
    ...
    return {
        "message": "Contractor offer published successfully",
        "offer": offer.to_dict()
    }, 201
...
def get_published_offers(request_id):
    ...
    return {"offers": [offer.to_dict() for offer in offers]}, 200
...
def accept_contractor_offer(offer_id, provider_id):
    ...
    return {
        "message": "Offer submitted successfully — awaiting client selection",
        "offer": offer.to_dict()
    }, 200
...
def respond_to_offer(offer_id, data):
    ...
    return {
        "message": "Your offer submitted successfully — awaiting client selection",
        "offer": offer.to_dict()
    }, 200
