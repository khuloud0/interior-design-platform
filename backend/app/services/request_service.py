...
def create_design_request(data):
    ...
    return {
        ...
        "design_request": {
            ...
            "city": design_request.city,
            "country": design_request.country,
...
def get_design_request_by_id(request_id):
    ...
    return {
        "request": {
            ...
            # ✅ city و country في الـ response
            "city":                     design_request.city,
            "country":                  design_request.country,
            "status":                   design_request.status,
...
def update_design_request(request_id, data):
    ...
    # ✅ تحديث city و country
    design_request.city             = data.get("city",             design_request.city)
    design_request.country          = data.get("country",          design_request.country)
