...
export default function ProviderSidebar({ variant = "light" }) {
  ...
  const navItems = [
    { icon: <LayoutGrid size={18} strokeWidth={1.5} />, label: "Available Offers", path: "/provider/offers" },
    { icon: <FileText size={18} strokeWidth={1.5} />, label: "My Projects", path: "/provider/projects" },
    { icon: <User size={18} strokeWidth={1.5} />, label: "My Profile", path: "/provider/profile" },
    { icon: <Settings size={18} strokeWidth={1.5} />, label: "Settings", path: "/provider/settings" },
  ];
  ...
  return (
    <>
      ...
      <div className="provider-sidebar-desktop">
        {sidebarContent}
      </div>

      <div
        className={`provider-drawer-overlay ${open ? "open" : ""}`}
        onClick={() => setOpen(false)}
      />

      <div className={`provider-sidebar-drawer ${open ? "open" : ""}`}>
        <button
          onClick={() => setOpen(false)}
