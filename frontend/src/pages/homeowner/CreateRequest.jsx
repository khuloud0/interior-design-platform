...
const inputStyle = (hasError) => ({
  width: "100%", background: C.sec, fontSize: 13,
  border: `1px solid ${hasError ? C.error : C.border}`,
  borderRadius: 10, padding: "10px 14px",
  fontFamily: f.font, fontWeight: 300, color: C.mid,
});
...
const DEFAULT = {
  service_type: "", space_type: "", space_details: "",
  preferred_style: "", preferred_colors: "", budget: "",
  city: "", country: "",
};
...
export default function CreateRequest() {
  ...
  const validateStep = () => {
    ...
    if (step === 1 && !form.city)             e.city            = "Required";
    if (step === 1 && !form.country)          e.country         = "Required";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!res.ok) { setMessage(data.error || "Failed."); setIsError(true); }
        ...
        setMessage(editMode ? "Request updated!" : "Request submitted!");
        setIsError(false);
                ...
                {step === 1 && (
                  <div>
                    ...
                    <div style={{ marginBottom: 20 }}>
                      ...
                      <Row>
                        <div>
                          ...
                          />
                          {errors.city && <div style={{ fontSize: 10.5, color: C.error, marginTop: 4 }}>{errors.city}</div>}
                        </div>
                        <div>
                          <input
                            className="sw-inp"
                          ...
                          />
                          {errors.country && <div style={{ fontSize: 10.5, color: C.error, marginTop: 4 }}>{errors.country}</div>}
                        </div>
                      </Row>
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        className="sw-ta"
                        placeholder="e.g. Medium-sized living room, needs full redesign..."
                        value={form.space_details}
                        onChange={e => setField("space_details", e.target.value)}
                        rows={4}
                        style={{ width: "100%", background: C.sec, resize: "vertical", border: `1px solid ${errors.space_details ? C.error : C.border}`, borderRadius: 10, padding: "10px 14px", fontSize: 12.5, fontFamily: f.font, fontWeight: 300, color: C.mid, lineHeight: 1.7 }}
                      />
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        style={inputStyle(!!errors.preferred_colors)}
                      />
                  ...
                  <div>
                    <div style={{ marginBottom: 22 }}>
                      ...
                      <div style={{ position: "relative" }}>
                        ...
                        <input
                          ...
                          style={{ width: "100%", background: C.sec, fontSize: 13, border: `1px solid ${errors.budget ? C.error : C.border}`, borderRadius: 10, padding: "10px 14px 10px 46px", fontFamily: f.font, fontWeight: 300, color: C.mid }}
                        />
                      </div>
                    ...
                    <div style={{ background: C.sectionBg, border: `0.5px solid ${C.border}`, borderRadius: 12, padding: "16px 18px", marginBottom: 22 }}>
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 9 }}>
                        {[
                          ...
                          { label: "Location", val: form.city && form.country ? `${form.city}, ${form.country}` : form.city || form.country || "—" },
                    ...
                    <div onClick={() => inputRef.current?.click()} style={{ border: `0.5px dashed ${C.border}`, borderRadius: 10, padding: "18px 20px", textAlign: "center", background: C.sec, cursor: "pointer" }}>
                      ...
                      <div style={{ fontSize: 12, color: C.muted }}>
                        {files.length === 0
                          ? <>Drop files or <span style={{ color: C.stone, textDecoration: "underline" }}>browse</span></>
