      ...
      <div style={{ display: "flex", height: "100vh", fontFamily: "'Jost', sans-serif", background: c.bg }}>
        ...
        <main style={{ flex: 1, overflowY: "auto", padding: "32px 40px" }}>
          ...
          <div style={{ background: c.card, border: `0.5px solid ${c.border}`, borderRadius: 16, overflow: "hidden" }}>
            <div style={{ padding: "18px 24px", borderBottom: `0.5px solid ${c.border}` }}>
            ...
            {loading ? (
              ...
              <div style={{ padding: "48px 32px", textAlign: "center" }}>
                ...
                <p style={{ fontSize: 12, color: c.muted, fontWeight: 300, lineHeight: 1.75, maxWidth: 300, margin: "0 auto" }}>
                  You haven't submitted any design requests yet. Browse our designers and request one to get started.
                </p>
              </div>
            ) : (
