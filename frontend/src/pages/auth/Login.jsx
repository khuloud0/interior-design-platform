        ...
        <div style={{
          ...
          <form onSubmit={handleLogin}>
            ...
            <div style={{ marginBottom: "14px" }}>
              ...
              />
              {errors.email && (
                <div style={{ fontSize: "10px", color: c.error, marginTop: "4px" }}>{errors.email}</div>
              )}
            </div>
            ...
            <div style={{ marginBottom: "14px" }}>
              ...
              {errors.password && (
                <div style={{ fontSize: "10px", color: c.error, marginTop: "4px" }}>{errors.password}</div>
              )}
            </div>
            ...
            <div style={{ textAlign: "right", marginBottom: "6px" }}>
              <a href="/forgot-password" style={{
                fontSize: "10px", color: c.stone, textDecoration: "none",
            ...
            <button
              ...
              style={{
                ...
                marginTop: "6px", opacity: loading ? 0.5 : 1,
          ...
          <p style={{ marginTop: "16px", textAlign: "center", fontSize: "12px", color: c.muted, fontWeight: 300 }}>
            ...
            <a href="/signup" style={{ color: c.stone, fontWeight: 500, textDecoration: "none" }}>
              Sign up
            </a>
          </p>
