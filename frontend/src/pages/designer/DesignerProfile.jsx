            ...
            <div style={{
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 18, marginBottom: 32 }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <span style={{ fontSize: 12, color: C.stone }}>Based In</span>
                  <span style={{ fontSize: 12, color: C.dark, textAlign: "right" }}>{d.city || "Saudi Arabia"}</span>
                </div>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <span style={{ fontSize: 12, color: C.stone }}>Years of Experience</span>
                  <span style={{ fontSize: 12, color: C.dark, textAlign: "right" }}>{d.years_experience ? `${d.years_experience}+` : "—"}</span>
                </div>
              </div>
              ...
              {d.bio && (
                <div style={{ marginBottom: 32 }}>
                  <div style={{ fontSize: 11, color: C.stone, letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 10 }}>About</div>
                  <p style={{ fontSize: 12, color: C.mid, lineHeight: 1.8, fontWeight: 300 }}>{d.bio}</p>
                </div>
              )}
